    ...
    <div class="context">
      <div class="Office">
        ...
        <div class="details">
          ...
          <el-link style="display:block;" v-for="val in Office.filePath" :key="val" @click="download(val)">{{val.split('.').slice(-2)[0]+'.'+val.split('.').slice(-2)[1]}}</el-link>


          <div class="button">
            <button class="button button1" @click="deleteById(Office.id,Office.template_TYPE)">删除</button>
